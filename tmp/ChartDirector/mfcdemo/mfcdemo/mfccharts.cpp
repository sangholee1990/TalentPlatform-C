...
BaseChart *iconpie2(int /* chartIndex */, const char **imageMap)
{
    ...
    // effect
    c->addTitle(
        "<*block,valign=absmiddle*><*img=@/PNG/doc.png*> Customer Survey: "
    ...
    c->addTitle(Chart::BottomRight,
        "<*block,valign=absmiddle*><*img=@/PNG/molecule.png*> <*block*><*color=FF*>"
...
BaseChart *splineline(int /* chartIndex */, const char **imageMap)
{
    ...
    c->addTitle(
        ...
        "Enhancer <*img=@/PNG/star.png*><*img=@/PNG/star.png*><*/*>", "timesbi.ttf", 15, 0xffffff
    ...
    c->addText(575, 250,
        "<*block,valign=absmiddle*><*img=@/PNG/small_molecule.png*> <*block*>"
...
BaseChart *errline(int /* chartIndex */, const char **imageMap)
{
    ...
    c->addTitle(
        ...
        "Temperature Control <*img=@/PNG/star.png*><*img=@/PNG/star.png*><*/*>", "timesbi.ttf", 15
...
BaseChart *customsymbolline(int /* chartIndex */, const char **imageMap)
{
    ...
    layer->addDataSet(DoubleArray(data0, (int)(sizeof(data0) / sizeof(data0[0]))), 0xcf4040, "Users"
        )->setDataSymbol("@/PNG/small_user.png");

    // Add the first line using small_computer.png as the symbol.
    layer->addDataSet(DoubleArray(data1, (int)(sizeof(data1) / sizeof(data1[0]))), 0x40cf40,
        "Computers")->setDataSymbol("@/PNG/small_computer.png");
...
BaseChart *enhancedarea(int /* chartIndex */, const char **imageMap)
{
    ...
    TextBox *title = c->addTitle(
        "<*block,valign=absmiddle*><*img=@/PNG/star.png*><*img=@/PNG/star.png*> Performance "
        "Enhancer <*img=@/PNG/star.png*><*img=@/PNG/star.png*><*/*>", "timesbi.ttf", 18);
...
BaseChart *yzonecolor(int /* chartIndex */, const char **imageMap)
{
    ...
    c->addTitle(
        ...
        "<*img=@/PNG/star.png*><*img=@/PNG/star.png*><*/*>", "arialbi.ttf", 13, 0xffffff
        )->setBackground(0x000000, -1, 1);
...
DemoChart demoCharts[] = 
{
    ...
    {"Trending and Curve Fitting", 0, 0, "trendicon.bmp"},
    ...
    {"Scatter/Bubble/Vector Charts", 0, 0, "bubbleicon.bmp"},
    ...
    {"Floating Box/Waterfall Charts", 0, 0, "boxicon.bmp"},
    ...
    {"Finance Charts", 0, 0, "financeicon.bmp"},
    ...
    {"Other XY Chart Features", 0, 0, "xyicon.bmp"},
    ...
    {"Surface Charts", 0, 0, "surfaceicon.bmp"},
    ...
    {"3D Scatter Charts", 0, 0, "3dscattericon.bmp"},
    ...
    {"Polar/Radar Charts", 0, 0, "polaricon.bmp"},
    ...
    {"Pyramids/Cones/Funnels", 0, 0, "pyramidicon.bmp"},
    ...
    {"Angular Meters/Guages", 0, 0, "metericon.bmp"},
    ...
    {"Linear Meters/Guages", 0, 0, "linearmetericon.bmp"},
    ...
    {"Bar Meters/Guages", 0, 0, "barmetericon.bmp"},
